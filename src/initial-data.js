const initialData = {
    tasks: {
        'task-1': { id: 'task-1', content: 'Donatello', price: 39.99, segment: 'Consultoria'},
        'task-2': { id: 'task-2', content: 'Caravaggio', price: 0, segment: 'Comércio'},
        'task-3': { id: 'task-3', content: 'Michelangelo', price: 39.99, segment: 'Consultoria'},
        'task-4': { id: 'task-4', content: 'Rafael', price: 0, segment: 'Comércio '},
        'task-5': { id: 'task-5', content: 'Sandro Botticelli', price: 39.99, segment: 'Restaurante'},
        'task-6': { id: 'task-6', content: 'Filippo Brunelleschi', price: 39.99, segment: 'Consultoria'},
        ...
        'task-9': { id: 'task-9', content: 'Jan van Eyck', price: 0, segment: 'Consultoria'},
        'task-10': { id: 'task-10', content: 'Giorgio Vasari', price: 39.99, segment: 'Comércio'},
    },
    columns: {
        'column-1': {
            id: 'column-1',
